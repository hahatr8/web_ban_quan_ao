            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        ...
                        <button type="button" class="btn btn-info m-3"><a href="{{route('admin.products.index')}}">Q/L Trang chủ</a></button>
                    </div><!-- end card header -->
                    <div class="card-body">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <textarea class="form-control" name="user_manual" id="user_manual" rows="2">{{ $product->user_manu }}</textarea>
                                        </div>
                                        <div class="mt-3">
