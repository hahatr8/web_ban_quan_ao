...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        return view(self::PATH_VIEW . __FUNCTION__, compact('category', 'colors', 'sizes', 'tags'));
    }
    ...
    public function edit(Product $product)
    {
        ...
        return view(self::PATH_VIEW . __FUNCTION__, compact('product', 'category', 'colors', 'sizes', 'tags'));
    }
